        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-6 items-center">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="p-2 bg-slate-900 rounded-lg hover:text-[#1877F2] transition-colors border border-slate-800">
                <Facebook className="w-5 h-5" />
              </a>
              
              <a href="#" className="p-2 bg-slate-900 rounded-lg hover:text-[#FF0000] transition-colors border border-slate-800">
          ...
          {/* Business Hours */}
          <div>
            <h3 className="text-white font-bold text-lg mb-6">Mobile Service Hours</h3>
            <ul className="space-y-2 text-sm">
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 space-y-4 md:space-y-0">
          <p>
            ...
            <span className="version-tag">
             ...
             © {currentYear} FNH Contracting Trading And Services. All Rights Reserved.</p>
          <div className="flex space-x-6">
            <a href="#" className="hover:text-slate-300">Design & Developed By 
              <span className="text-blue-700"> SoftXpertz </span>
            </a>
